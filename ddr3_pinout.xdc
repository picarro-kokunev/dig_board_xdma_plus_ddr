...
set_property PACKAGE_PIN W6 [get_ports {ddr3_addr[1]}]
...
set_property PACKAGE_PIN V5 [get_ports {ddr3_addr[12]}]
...
set_property PACKAGE_PIN Y4 [get_ports {ddr3_ck_p[0]}]

set_property SLEW FAST [get_ports {ddr3_ck_n[0]}]
set_property IOSTANDARD DIFF_SSTL15 [get_ports {ddr3_ck_n[0]}]
set_property PACKAGE_PIN AA4 [get_ports {ddr3_ck_n[0]}]
