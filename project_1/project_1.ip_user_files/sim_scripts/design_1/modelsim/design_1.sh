...
#
# Script generated by Vivado on Tue Jul 14 09:44:29 PDT 2026
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kokunev/data/git_root/dig_board_xdma_plus_ddr/project_1/project_1.cache/compile_simlib/modelsim"
  fi
