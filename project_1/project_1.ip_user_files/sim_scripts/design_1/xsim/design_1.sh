...
export RDI_DATADIR="/opt/Xilinx_2/2025.2/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/opt/Xilinx_2/2025.2/data/xsim"
  fi
