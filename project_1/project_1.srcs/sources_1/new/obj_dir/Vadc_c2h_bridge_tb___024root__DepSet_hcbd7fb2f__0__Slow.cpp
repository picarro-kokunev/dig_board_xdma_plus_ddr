...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_static__TOP(Vadc_c2h_bridge_tb___024root* vlSelf);

VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_static(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___eval_static\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vadc_c2h_bridge_tb___024root___eval_static__TOP(vlSelf);
}

VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_static__TOP(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___eval_static__TOP\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_initial__TOP(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___eval_initial__TOP\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.adc_c2h_bridge_tb__DOT__u_adc_ctrl__DOT__adc_clk_reg = 0U;
}

VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_final(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___eval_final\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___dump_triggers__stl(Vadc_c2h_bridge_tb___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vadc_c2h_bridge_tb___024root___eval_phase__stl(Vadc_c2h_bridge_tb___024root* vlSelf);

VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_settle(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___eval_settle\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vadc_c2h_bridge_tb___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("adc_c2h_bridge_tb.sv", 15, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vadc_c2h_bridge_tb___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___dump_triggers__stl(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___dump_triggers__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___stl_sequent__TOP__0(Vadc_c2h_bridge_tb___024root* vlSelf);

VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_stl(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___eval_stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vadc_c2h_bridge_tb___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___stl_sequent__TOP__0(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___stl_sequent__TOP__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___eval_triggers__stl(Vadc_c2h_bridge_tb___024root* vlSelf);

VL_ATTR_COLD bool Vadc_c2h_bridge_tb___024root___eval_phase__stl(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___eval_phase__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vadc_c2h_bridge_tb___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vadc_c2h_bridge_tb___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___dump_triggers__act(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___dump_triggers__act\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___dump_triggers__nba(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___dump_triggers__nba\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vadc_c2h_bridge_tb___024root___ctor_var_reset(Vadc_c2h_bridge_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadc_c2h_bridge_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadc_c2h_bridge_tb___024root___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__pkt_beat_cnt = VL_RAND_RESET_I(9);
    for (int __Vi0 = 0; __Vi0 < 128; ++__Vi0) {
        vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__mem[__Vi0] = VL_RAND_RESET_I(16);
    }
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_bin = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_bin = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_gray = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_bin_next = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray_next = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_bin_next = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_gray_wclk_r1 = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_gray_wclk_r2 = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray_rclk_r1 = VL_RAND_RESET_I(12);
    vlSelf->adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray_rclk_r2 = VL_RAND_RESET_I(12);
