...
#ifndef VERILATED_VADC_AD_LTC22XX___024ROOT_H_
#define VERILATED_VADC_AD_LTC22XX___024ROOT_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"


class Vadc_ad_ltc22xx__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vadc_ad_ltc22xx___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*2:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__pkt_beat_cnt;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_bin;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_bin;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_gray;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_bin_next;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray_next;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_bin_next;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_gray_wclk_r1;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__rd_ptr_gray_wclk_r2;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray_rclk_r1;
        CData/*7:0*/ adc_c2h_bridge_tb__DOT__u_bridge__DOT__u_async_fifo__DOT__wr_ptr_gray_rclk_r2;
    ...
    // INTERNAL VARIABLES
    Vadc_ad_ltc22xx__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vadc_ad_ltc22xx___024root(Vadc_ad_ltc22xx__Syms* symsp, const char* v__name);
    ~Vadc_ad_ltc22xx___024root();
    VL_UNCOPYABLE(Vadc_ad_ltc22xx___024root);
