...
module blinker_hier_0_imp_N7ET4B
   (CLK,
    led_red_0);
  input CLK;
  ...
  assign led_red_0 = c_counter_binary_0_Q[25:25];
endmodule
...
module design_1
   (iic_a_scl_i,
    ...
    sys_clk_clk_n,
    sys_clk_clk_p);
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_a SCL_I" *) (* X_INTERFACE_MODE = "Master" *) input iic_a_scl_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_a SCL_O" *) output iic_a_scl_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_a SCL_T" *) output iic_a_scl_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_a SDA_I" *) input iic_a_sda_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_a SDA_O" *) output iic_a_sda_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_a SDA_T" *) output iic_a_sda_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_pcie SCL_I" *) (* X_INTERFACE_MODE = "Master" *) input iic_pcie_scl_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_pcie SCL_O" *) output iic_pcie_scl_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_pcie SCL_T" *) output iic_pcie_scl_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_pcie SDA_I" *) input iic_pcie_sda_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_pcie SDA_O" *) output iic_pcie_sda_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 iic_pcie SDA_T" *) output iic_pcie_sda_t;
  ...
  (* CONN_BUS_INFO = "axi_iic_1_IIC xilinx.com:interface:iic:1.0 None SCL_I" *) (* DONT_TOUCH *) wire axi_iic_1_IIC_SCL_I;
  (* CONN_BUS_INFO = "axi_iic_1_IIC xilinx.com:interface:iic:1.0 None SCL_O" *) (* DONT_TOUCH *) wire axi_iic_1_IIC_SCL_O;
  (* CONN_BUS_INFO = "axi_iic_1_IIC xilinx.com:interface:iic:1.0 None SCL_T" *) (* DONT_TOUCH *) wire axi_iic_1_IIC_SCL_T;
  (* CONN_BUS_INFO = "axi_iic_1_IIC xilinx.com:interface:iic:1.0 None SDA_I" *) (* DONT_TOUCH *) wire axi_iic_1_IIC_SDA_I;
  (* CONN_BUS_INFO = "axi_iic_1_IIC xilinx.com:interface:iic:1.0 None SDA_O" *) (* DONT_TOUCH *) wire axi_iic_1_IIC_SDA_O;
  (* CONN_BUS_INFO = "axi_iic_1_IIC xilinx.com:interface:iic:1.0 None SDA_T" *) (* DONT_TOUCH *) wire axi_iic_1_IIC_SDA_T;
  ...
  assign axi_iic_0_IIC_SCL_I = iic_pcie_scl_i;
  assign axi_iic_0_IIC_SDA_I = iic_pcie_sda_i;
  assign axi_iic_1_IIC_SCL_I = iic_a_scl_i;
  assign axi_iic_1_IIC_SDA_I = iic_a_sda_i;
  assign iic_a_scl_o = axi_iic_1_IIC_SCL_O;
  assign iic_a_scl_t = axi_iic_1_IIC_SCL_T;
  assign iic_a_sda_o = axi_iic_1_IIC_SDA_O;
  assign iic_a_sda_t = axi_iic_1_IIC_SDA_T;
  assign iic_pcie_scl_o = axi_iic_0_IIC_SCL_O;
  assign iic_pcie_scl_t = axi_iic_0_IIC_SCL_T;
  assign iic_pcie_sda_o = axi_iic_0_IIC_SDA_O;
  assign iic_pcie_sda_t = axi_iic_0_IIC_SDA_T;
  ...
  blinker_hier_0_imp_N7ET4B blinker_hier_0
  ...
  design_1_system_ila_0_0 system_ila_0
       (.SLOT_0_IIC_scl_i(axi_iic_0_IIC_SCL_I),
        ...
        .SLOT_1_IIC_scl_i(axi_iic_1_IIC_SCL_I),
        .SLOT_1_IIC_scl_o(axi_iic_1_IIC_SCL_O),
        .SLOT_1_IIC_scl_t(axi_iic_1_IIC_SCL_T),
        .SLOT_1_IIC_sda_i(axi_iic_1_IIC_SDA_I),
        .SLOT_1_IIC_sda_o(axi_iic_1_IIC_SDA_O),
        .SLOT_1_IIC_sda_t(axi_iic_1_IIC_SDA_T),
        .clk(util_ds_buf_0_IBUF_OUT));
endmodule
